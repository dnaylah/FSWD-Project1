...
jump_street = media.Movie("21 Jump Street",
                        ...
                        "http://popculturegalaxy.com/wp-content/uploads/2013/04/21-jump-street-2.jpg",
...
sideways = media.Movie("Sideways",
                       "2 friends who find themselves during a bachelor party trip",
...
super_troopers = media.Movie("Super Troopers",
                             "Cops gone wild",
                             "http://www.caddycat.com/Ebay/Super_Troopers-1.jpg",
                             "https://www.youtube.com/watch?v=2-9D2qUHN-E",
                             "(2002)")

tomorrow_never_dies = media.Movie("Tomorrow Never Dies",
                                  "James Bond film",
                                  "http://1.bp.blogspot.com/-118OGkSTyHE/UNC6C-FPZ5I/AAAAAAAAGMk/CJbMcc1d6mo/s1600/Tomorrow-Never-Dies.jpg",
...
pineapple_express = media.Movie("Pineapple Express",
                                ...
                                "http://theblemish.com/images/2008/08/pineapple_express-500x743.jpg",
                                "https://www.youtube.com/watch?v=wWbEoEJsxYw",
                                "(2008)")

movies = [jump_street, avatar, sideways, super_troopers, tomorrow_never_dies, pineapple_express]
